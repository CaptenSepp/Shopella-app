...
import ProductGallery from '@/features/products/next/components/ProductGallery'
  ...
  return (
    <div className="product-details-page">
      <div className="product-details-page__back">
        <Link href="/products" className="app-text-link">
          Back to products
        </Link>
      </div>
...
const ProductDetailsState = ({ message, onRetry, title }: { message: string; onRetry?: () => void; title: string }) => (
  <div className="app-state-panel app-page-shell app-page-shell--center">
    ...
    {onRetry ? <button type="button" className="btn btn-primary" onClick={onRetry}>Try again</button> : <Link href="/products" className="btn btn-primary">Browse products</Link>}
  </div>
)

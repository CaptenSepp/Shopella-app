...
const ProductCard = ({ product }: { product: Product }) => {
  ...
  return (
    <div className="flex flex-col">
      <Link href={`/products/${product.id}`} className={`card card--product ${productImageClass} bg-center relative block`} style={{ backgroundImage: `url(${productImageUrl})` }} aria-label={`View ${product.title}`}>

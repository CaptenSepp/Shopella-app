...
import Link from 'next/link' // router links
  ...
  if (!user) { // protect orders page
    return (
      <div className="app-page-shell app-page-shell--narrow app-page-shell--center">
        ...
        <Link href="/login" className="btn btn-primary">Go to login</Link> {/* CTA */}
      </div>
    )
  }
  ...
  if (orders.length === 0) { // empty state
    return (
      <div className="app-page-shell app-page-shell--narrow app-page-shell--center">
        ...
        <Link href="/products" className="btn btn-primary">Browse products</Link> {/* CTA */}
      </div>
    )
  }

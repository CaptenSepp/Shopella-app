    ...
    <div ref={pageRef} className="about-page">
      <section className="about-hero">
        <div className="about-hero__content">
          ...
          <div className="about-hero__actions"><Link className="btn btn-primary" href="/products">Browse Products</Link><Link className="btn btn-secondary" href="/products?sale=1&sort=price-asc">Shop Deals</Link></div>
        </div>
      </section>
      ...
      <section className="about-story">
        ...
        <div className="about-story__media"><Image src={storyImg} alt="Our Story" className="about-story__image" /></div>
      </section>
      <AboutValuesSection />
      <AboutTeamSection />
      <section className="about-cta">
        <div className="about-cta__box">
          ...
          <div className="about-cta__actions"><Link className="btn btn-primary" href="/products">Browse Products</Link><Link className="btn btn-secondary" href="/products?sale=1&sort=price-asc">Shop Deals</Link></div>
        </div>
      </section>
    </div>
  )
